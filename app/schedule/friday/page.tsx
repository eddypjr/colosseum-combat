        ...
        <div className="flex flex-col gap-3">
          ...
          <ul className="flex justify-between w-full  maxMd:flex-col maxMd:text-center">
            ...
            <li className="p-[25px] bg-[#f2f2f2] w-full text-center">
              ...
              <p className="text-[18px] text-black font-bold mt-3">Floyd Mayweather</p>
            </li>
          ...
          <ul className="flex justify-between w-full  maxMd:flex-col maxMd:text-center">
            ...
            <li className="py-[25px] px-[55px] bg-[#f2f2f2] w-full">
              ...
              <p className="text-[18px] text-black font-bold mt-3">Brazilian Jiu Jitsu</p>
            </li>
            {/* time */}
            <li className="p-[25px] bg-[#f2f2f2] w-full text-center">
              <p className="text-[14px] font-medium text-[#a0a0a0]">Time</p>
          ...
          <ul className="flex justify-between w-full  maxMd:flex-col maxMd:text-center">
            ...
            <li className="py-[25px] px-[55px] bg-[#f2f2f2] w-full">
              ...
              <p className="text-[18px] text-black font-bold mt-3">Strength & Conditioning</p>
            </li>
            {/* time */}
            <li className="p-[25px] bg-[#f2f2f2] w-full text-center">
              <p className="text-[14px] font-medium text-[#a0a0a0]">Time</p>
