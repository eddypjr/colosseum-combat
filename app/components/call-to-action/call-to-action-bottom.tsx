  ...
  return (
    <>
      <section className="cta-section w-full h-auto maxLg:bg-none maxLg:bg-black">
        <div className="container page-padding py-[7rem] maxMd:py-[4rem] text-white maxLg:text-black maxLg:flex maxLg:flex-col maxLg:gap-12  maxLg:items-center maxLg:text-center">
